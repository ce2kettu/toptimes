...
ROW_FONT = dxCreateFont("fonts/Inter-UI-Regular.ttf", math.floor(8 * ratioY))
ROW_SIZE = dxGetFontHeight(ROW_FONT_SIZE, ROW_FONT) + ROW_PADDING_Y
COLUMN_HEIGHT_MULTIPLIER = 1.15
COLUMN_FONT_SIZE = 1
COLUMN_FONT = dxCreateFont("fonts/Inter-UI-Medium.ttf", math.floor(7 * ratioY))
...
HIGHLIGHT_IMAGE_PATH = "images/gradient_highlight.png"
...
function Leaderboard.main()
	...
	Leaderboard.addColumn({
		...
		computed = function(row)
			return row and row.country and Leaderboard.flags[row.country] or "XX"
		end,
		alignX = nil,
		alignY = nil,
		rowAlignX = nil,
...
addEventHandler("onClientPlayerReady", root, function()
